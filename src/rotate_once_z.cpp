/**
* @file rotate_once_z.cpp
* @brief Turn 360 degrees about z axis
* @author Takaki Ueno
*/
...
int main(int argc, char** argv)
{
  ...
  // about PI/5 radian per second
  target_vel_msg.twist.angular.z = 0.63;

  ROS_INFO("Vehicle rotating...");

  ros::Time rotation_start = ros::Time::now();
  // Rotates until 10 seconds elapse
  // 10 [sec] * pi/5 [rad/sec] = 2pi [rad]
  while (ros::Time::now() - rotation_start < ros::Duration(10.0))
  {
